...
`,Ia=Symbol.for(""),nl=t=>{if((t==null?void 0:t.r)===Ia)return t==null?void 0:t._$litStatic$},wr=(t,...e)=>({_$litStatic$:e.reduce((i,r,o)=>i+(s=>{if(s._$litStatic$!==void 0)return s._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${s}. Use 'unsafeStatic' to pass non-literal values, but
...
`,Si=Symbol(),tr=Symbol(),ro,oo=new Map,qt=class extends E{constructor(){super(...arguments),this.svg=null,this.label="",this.library="default"}static async resolveIcon(t){var e;let i;try{if(i=await fetch(t,{mode:"cors"}),!i.ok)return i.status===410?Si:tr}catch{return tr}try{const r=document.createElement("div");r.innerHTML=await i.text();const o=r.firstElementChild;if(((e=o==null?void 0:o.tagName)==null?void 0:e.toLowerCase())!=="svg")return Si;ro||(ro=new DOMParser);const n=ro.parseFromString(o.outerHTML,"text/html").body.querySelector("svg");return n?(n.part.add("svg"),document.adoptNode(n)):Si}catch{return Si}}connectedCallback(){super.connectedCallback(),xl(this)}firstUpdated(){this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),kl(this)}getUrl(){const t=Ls(this.library);return this.name&&t?t.resolver(this.name):this.src}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var t;const e=Ls(this.library),i=this.getUrl();if(!i){this.svg=null;return}let r=oo.get(i);r||(r=qt.resolveIcon(i),oo.set(i,r));const o=await r;if(o===tr&&oo.delete(i),i===this.getUrl())switch(o){case tr:case Si:this.svg=null,this.emit("sl-error");break;default:this.svg=o.cloneNode(!0),(t=e==null?void 0:e.mutator)==null||t.call(e,this.svg),this.emit("sl-load")}}render(){return this.svg}};qt.styles=$l;a([R()],qt.prototype,"svg",2);a([c({reflect:!0})],qt.prototype,"name",2);a([c()],qt.prototype,"src",2);a([c()],qt.prototype,"label",2);a([c({reflect:!0})],qt.prototype,"library",2);a([x("label")],qt.prototype,"handleLabelChange",1);a([x(["name","src","library"])],qt.prototype,"setIcon",1);qt=a([z("sl-icon")],qt);var Cl=T`
  ${I}
...
`;function Rs(t,e,i){return t?e():i==null?void 0:i()}var q=class extends E{constructor(){super(...arguments),this.localize=new K(this),this.indeterminate=!1,this.isLeaf=!1,this.loading=!1,this.selectable=!1,this.expanded=!1,this.selected=!1,this.disabled=!1,this.lazy=!1}static isTreeItem(t){return t instanceof Element&&t.getAttribute("role")==="treeitem"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","treeitem"),this.setAttribute("tabindex","-1"),this.isNestedItem()&&(this.slot="children")}firstUpdated(){this.childrenContainer.hidden=!this.expanded,this.childrenContainer.style.height=this.expanded?"auto":"0",this.isLeaf=!this.lazy&&this.getChildrenItems().length===0,this.handleExpandedChange()}async animateCollapse(){this.emit("sl-collapse"),await st(this.childrenContainer);const{keyframes:t,options:e}=tt(this,"tree-item.collapse",{dir:this.localize.dir()});await et(this.childrenContainer,xr(t,this.childrenContainer.scrollHeight),e),this.childrenContainer.hidden=!0,this.emit("sl-after-collapse")}isNestedItem(){const t=this.parentElement;return!!t&&q.isTreeItem(t)}handleChildrenSlotChange(){this.loading=!1,this.isLeaf=!this.lazy&&this.getChildrenItems().length===0}willUpdate(t){t.has("selected")&&!t.has("indeterminate")&&(this.indeterminate=!1)}async animateExpand(){this.emit("sl-expand"),await st(this.childrenContainer),this.childrenContainer.hidden=!1;const{keyframes:t,options:e}=tt(this,"tree-item.expand",{dir:this.localize.dir()});await et(this.childrenContainer,xr(t,this.childrenContainer.scrollHeight),e),this.childrenContainer.style.height="auto",this.emit("sl-after-expand")}handleLoadingChange(){this.setAttribute("aria-busy",this.loading?"true":"false"),this.loading||this.animateExpand()}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleExpandedChange(){this.isLeaf?this.removeAttribute("aria-expanded"):this.setAttribute("aria-expanded",this.expanded?"true":"false")}handleExpandAnimation(){this.expanded?this.lazy?(this.loading=!0,this.emit("sl-lazy-load")):this.animateExpand():this.animateCollapse()}handleLazyChange(){this.emit("sl-lazy-change")}getChildrenItems({includeDisabled:t=!0}={}){return this.childrenSlot?[...this.childrenSlot.assignedElements({flatten:!0})].filter(e=>q.isTreeItem(e)&&(t||!e.disabled)):[]}render(){const t=this.localize.dir()==="rtl",e=!this.loading&&(!this.isLeaf||this.lazy);return w`
      <div
        part="base"
...
`,Fl=0,di=class extends E{constructor(){super(...arguments),this.attrId=++Fl,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return w`
      <slot
        part="base"
        class=${P({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};di.styles=Bl;a([c({reflect:!0})],di.prototype,"name",2);a([c({type:Boolean,reflect:!0})],di.prototype,"active",2);a([x("active")],di.prototype,"handleActiveChange",1);di=a([z("sl-tab-panel")],di);var Ul=T`
  ${I}
  ${Ji}
...
`,kr=class extends E{constructor(){super(...arguments),this.effect="none"}render(){return w`
      <div
        part="base"
    ...
    `}};kr.styles=Xl;a([c()],kr.prototype,"effect",2);kr=a([z("sl-skeleton")],kr);var Yl=T`
  ${Oa}
...
`,$r=class extends E{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){const i=t.target.closest("sl-menu-item");!i||i.disabled||i.inert||(i.type==="checkbox"&&(i.checked=!i.checked),this.emit("sl-select",{detail:{item:i}}))}handleKeyDown(t){if(t.key==="Enter"){const e=this.getCurrentItem();t.preventDefault(),e==null||e.click()}if(t.key===" "&&t.preventDefault(),["ArrowDown","ArrowUp","Home","End"].includes(t.key)){const e=this.getAllItems(),i=this.getCurrentItem();let r=i?e.indexOf(i):0;e.length>0&&(t.preventDefault(),t.key==="ArrowDown"?r++:t.key==="ArrowUp"?r--:t.key==="Home"?r=0:t.key==="End"&&(r=e.length-1),r<0&&(r=e.length-1),r>e.length-1&&(r=0),this.setCurrentItem(e[r]),e[r].focus())}}handleMouseDown(t){const e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){const t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===t?"0":"-1")})}render(){return w`
      <slot
        ...
        @mousedown=${this.handleMouseDown}
      ></slot>
    `}};$r.styles=cc;a([$("slot")],$r.prototype,"defaultSlot",2);$r=a([z("sl-menu")],$r);var dc=T`
  ${I}
...
`,zt=class extends E{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?wr`a`:wr`button`;return Oi`
      <${e}
        part="base"
 ...
 */const Ju=t=>t??ot;var Qu=Object.defineProperty,Zu=Object.getOwnPropertyDescriptor,pn=(t,e,i,r)=>{for(var o=r>1?void 0:r?Zu(e,i):e,s=t.length-1,n;s>=0;s--)(n=t[s])&&(o=(r?n(e,i,o):n(o))||o);return r&&o&&Qu(e,i,o),o},fn=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},B=(t,e,i)=>(fn(t,e,"read from private field"),i?i.call(t):e.get(t)),ar=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},nr=(t,e,i,r)=>(fn(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),lt,Y,Mo,fe;let Ir=class extends ee{constructor(){super(),ar(this,lt,void 0),ar(this,Y,void 0),this.chat="",this.changeChat=t=>{const e=t.target;this.chat=e.value},this.pressChat=t=>{t.key==="Enter"&&this.chat.trim()&&(t.preventDefault(),B(this,Y).scenario==="ToiletRun"&&this.delayHistory(),B(this,Y).gameId&&B(this,Y).name&&B(this,lt).addMessage(B(this,Y).gameId,B(this,Y).name,this.chat.trim()),this.chat="")},ar(this,Mo,()=>{const t=document.documentElement.scrollHeight;setTimeout(()=>{window.scrollTo({top:t,behavior:"smooth"})},0)}),ar(this,fe,null),this.copyGameLink=()=>{navigator.clipboard.writeText(`${new URL(window.location.href).origin}/name?`+B(this,Y).queryParams)},this.resetGame=()=>{this.setupRoom(),B(this,lt).reset()},nr(this,lt,hr.Instance()),nr(this,Y,Ge.Instance())}async getHistory(){B(this,Y).scenario==="ToiletRun"&&this.delayHistory(),B(this,Y).gameId&&await B(this,lt).getHistory(B(this,Y).gameId)}delayHistory(){B(this,fe)&&(window.clearInterval(B(this,fe)),nr(this,fe,null)),window.setTimeout(()=>{nr(this,fe,window.setInterval(async()=>{B(this,Y).gameId&&await B(this,lt).getHistory(B(this,Y).gameId)},3e3))})}connectedCallback(){super.connectedCallback(),B(this,lt).reset(),this.setupRoom(),B(this,lt).addEventListener(te.loading,()=>this.requestUpdate()),B(this,lt).addEventListener(te.endMessage,()=>this.requestUpdate()),B(this,lt).addEventListener(te.history,()=>{this.requestUpdate(),B(this,Mo).call(this)})}disconnectedCallback(){super.disconnectedCallback(),B(this,fe)&&window.clearInterval(B(this,fe))}async setupRoom(){const t=new URLSearchParams(window.location.search);if(t.get("gameId")&&(B(this,Y).gameId=t.get("gameId")),t.get("scenario")&&(B(this,Y).scenario=t.get("scenario")),t.get("name")&&(B(this,Y).name=t.get("name")),!B(this,Y).name||!B(this,Y).scenario){Nt.go({pathname:"/",search:B(this,Y).queryParams});return}B(this,Y).gameId||await B(this,lt).initGame(B(this,Y).scenario),await this.getHistory()}reactionFace(){const t=B(this,lt).history.filter(e=>e.type==="Bot").at(-1);return t?t.expression:null}render(){if(!B(this,Y).scenario)return null;const t=uu[B(this,Y).scenario],e=this.reactionFace();return Ut`
      <div class="inner">
        ...
        <div class="container2">
          <message-list>
            ${hu(B(this,lt).history.filter(i=>i.content),i=>{const r=i.type==="User";return Ut`<message-bubble
                  ?bot=${!r}
                  ?user=${r}
        ...
        <div class="row-container">
          ${B(this,lt).endMessage?Ut`<h3>${B(this,lt).endMessage}</h3>`:null}
        </div>
        ...
        <div class="input-container">
          <sl-input
            ...
            enterkeyhint="send"
            .value=${Za(this.chat)}
            ?disabled=${!B(this,lt).loaded}
            placeholder="Action/Dialogue"
          >
            <sl-spinner ?completed=${B(this,lt).loaded} slot="suffix"></sl-spinner>
          </sl-input>
        </div>
      </div>
    `}};lt=new WeakMap;Y=new WeakMap;Mo=new WeakMap;fe=new WeakMap;Ir.styles=mi`
    :host {
      font-family: var(--sl-font-sans);
      font-size: var(--sl-font-size-medium);
      font-weight: var(--sl-font-weight-normal);
      ...
      <div>
        <nav>
          <sl-button
            ...
            href=${Bi.urlForPath("/game/?name=Jane&scenario=BadMil")}
            variant="primary"
          >
            Bad Mother In Law
          </sl-button>
        ...
        <nav>
          <sl-button
            ...
            ?up=${this.backend==="Up"}
            ?down=${this.backend==="Down"}
            href=${Bi.urlForPath("/game/?name=John&scenario=CarSale")}
            variant="success"
          >
            Sleazy Car Salesman
          </sl-button>
        ...
        <nav>
          <sl-button
            ...
            ?up=${this.backend==="Up"}
            ?down=${this.backend==="Down"}
            href=${Bi.urlForPath("/name/?scenario=ToiletRun")}
            variant="danger"
          >
  ...
  `;ts([bi({type:String})],Yi.prototype,"backend",2);ts([bi({type:Number})],Yi.prototype,"progress",2);Yi=ts([gi("landing-page")],Yi);var rp=Object.defineProperty,op=Object.getOwnPropertyDescriptor,gn=(t,e,i,r)=>{for(var o=r>1?void 0:r?op(e,i):e,s=t.length-1,n;s>=0;s--)(n=t[s])&&(o=(r?n(e,i,o):n(o))||o);return r&&o&&rp(e,i,o),o},bn=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},$e=(t,e,i)=>(bn(t,e,"read from private field"),i?i.call(t):e.get(t)),sp=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},ap=(t,e,i,r)=>(bn(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),Qt;let Lr=class extends ee{constructor(){super(),this.name="",sp(this,Qt,void 0),this.changeChat=t=>{const e=t.target;this.name=e.value},this.pressChat=t=>{t.key==="Enter"&&this.name.trim()&&($e(this,Qt).name=this.name.trim(),Nt.go({pathname:"/game?",search:$e(this,Qt).queryParams}))},ap(this,Qt,Ge.Instance())}connectedCallback(){super.connectedCallback();const t=new URLSearchParams(window.location.search);$e(this,Qt).scenario=t.get("scenario"),$e(this,Qt).gameId=t.get("gameId"),$e(this,Qt).scenario||Nt.go("/")}get submitName(){return this.name.trim()&&($e(this,Qt).name=this.name.trim()),Bi.urlForPath("/game?"+$e(this,Qt).queryParams)}render(){return Ut`
  ...
  `;gn([bi({type:String})],Lr.prototype,"name",2);Lr=gn([gi("name-page")],Lr);var np=Object.defineProperty,lp=Object.getOwnPropertyDescriptor,cp=(t,e,i,r)=>{for(var o=r>1?void 0:r?lp(e,i):e,s=t.length-1,n;s>=0;s--)(n=t[s])&&(o=(r?n(e,i,o):n(o))||o);return r&&o&&np(e,i,o),o};let Fo=class extends ee{render(){return Ut`<h1>404 Page</h1> `}};Fo.styles=mi`
    :host {
      margin: 0 auto;
      padding: 2rem;
      text-align: center;
    }
  `;Fo=cp([gi("not-found-page")],Fo);
